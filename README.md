...
A hands-on lab environment for **APC100 - MongoDB Atlas Search** course. This modern web application demonstrates how to build powerful search capabilities using MongoDB Atlas Search with the sample_mflix database.
